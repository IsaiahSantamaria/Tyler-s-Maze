...
Step 2: with Construct 3, open up tylerMazeGame(1.3).c3p
...
- Must know JavaScript, HTML, CSS and JSON to be able to edit these features
- Audio does not work with Live Preview by Microsoft
